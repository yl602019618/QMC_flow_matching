...
def plot_mc_vs_qmc(mc_results, qmc_results, snis_results_mc=None, snis_results_qmc=None,
    ...
    if snis_results_qmc is not None and 'mse_errors' in snis_results_qmc and snis_results_qmc['mse_errors']:
        ...
        plt.loglog(sample_sizes, snis_qmc_err, 'k-^', label='FM-ISQMC (q=flow)')
...
def main():
    ...
    # 画 RMSE 对比（新增 SNIS）
    plot_mc_vs_qmc(mc_res, qmc_res, snis_results_mc=snis_res_mc,snis_results_qmc=snis_res_qmc, save_path="results_logi/mc_qmc_snis_test_final.pdf")
